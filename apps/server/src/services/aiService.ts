  ...
  static async generateMangaPanel(
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.error(`[AI Service] Pollinations API returned error status ${response.status}:`, text);
      ...
      console.error('[AI Service] Unexpected error calling Pollinations API:', error);
